...
public class EmpVO {
	...
	public String toString() {
		return "EmpVO [USER_NO=" + USER_NO + ", USER_ID=" + USER_ID + ", USER_PASSWORD=" + USER_PASSWORD
				...
				+ ", USER_EMAIL=" + USER_EMAIL + ", SECRET_KEY=" + SECRET_KEY + ", USER_ZONECODE=" + USER_ZONECODE
				+ ", USER_ADDR1=" + USER_ADDR1 + ", USER_ADDR2=" + USER_ADDR2 + ", USER_REGNO1=" + USER_REGNO1
				+ ", USER_REGNO2=" + USER_REGNO2 + ", USER_GENDER=" + USER_GENDER + ", USER_LOGIN_TRY=" + USER_LOGIN_TRY
				+ ", USER_EMAIL_KEY=" + USER_EMAIL_KEY + "]";
	}
