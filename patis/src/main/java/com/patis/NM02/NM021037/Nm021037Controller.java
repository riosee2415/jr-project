...
/**
 * @author : 4LEAF.NJM
 * @SCREEN : 도시재생교육 -> 도시재생학교(school)
 *
 */
@Controller
public class Nm021037Controller {
	@Resource(name="middlewareService")
	private I_MiddlewareService middlewareService;

	@Resource(name="nm021037Service")
	private I_Nm021037Service nm021037Service;
	...
	public String sendScreen(Model model,
		...
		String b_type_1 = nm021037Service.getEduOfficeBoardType();
		String b_type_2 = nm021037Service.getEduSupportBoardType();
	...
	@RequestMapping(value="/school.detail.do", method=RequestMethod.GET)
	public String sendDetailScreen(Model model, 
		...
		switch(tab) {
		case 1:
			btype = nm021037Service.getEduOfficeBoardType();
			break;
		case 2:
			btype = nm021037Service.getEduSupportBoardType();
			break;
		}
		...
		switch(tab) {
		case 1:
			data = nm021037Service.getEduOffice(b_no);
			prevData = nm021037Service.getPrevEduOffice(params);
			nextData = nm021037Service.getNextEduOffice(params);
			break;
		case 2:
			data = nm021037Service.getEduSupport(b_no);
			prevData = nm021037Service.getPrevEduSupport(params);
			nextData = nm021037Service.getNextEduSupport(params);
			break;
		}
	...
	@ResponseBody
	@RequestMapping(value = "/edu_office.hitUp.do", method = RequestMethod.POST, produces="application/json")
	public Map<String, Object> ajaxEduOfficeHitUp(Model model,
			@RequestParam("b_no")int b_no) throws Exception {
		Map<String, Object> data = new HashMap<String, Object>();
		int result = nm021037Service.modifyEduOfficeHitUp(b_no);
		data.put("result", result);
		
		return data;
	}
	@ResponseBody
	@RequestMapping(value = "/edu_support.hitUp.do", method = RequestMethod.POST, produces="application/json")
	public Map<String, Object> ajaxEduSupportHitUp(Model model,
			@RequestParam("b_no")int b_no) throws Exception {
		Map<String, Object> data = new HashMap<String, Object>();
		int result = nm021037Service.modifyEduSupportHitUp(b_no);
		data.put("result", result);
		
		return data;
	}
	
	@RequestMapping(value="/school.write.do", method=RequestMethod.GET)
	public String schoolWrite(Model model,
								 HttpSession session,
		...
		switch(tab) {
		case 1:
			b_type = nm021037Service.getEduOfficeBoardType();
			break;
		case 2:
			b_type = nm021037Service.getEduSupportBoardType();
			break;
		}
	...
	@RequestMapping(value="/school.write.do", method=RequestMethod.POST)
	public String schoolWriteProcess(@RequestParam(value="parent")String parent,
				 						@RequestParam(value="code")String code,
				 						@RequestParam(value="tab")Integer tab,
		...
		if(mode.equals("WRITE")) {
			switch(tab) {
			case 1:
				nm021037Service.setEduOffice(boardVO);
				break;
			case 2:
				nm021037Service.setEduSupport(boardVO);
				break;
			}
			...
			switch(tab) {
			case 1:
				nm021037Service.modifyEduOffice(boardVO);
				break;
			case 2:
				nm021037Service.modifyEduSupport(boardVO);
				break;
			}
	...
	@RequestMapping(value="/school.remove.do", method=RequestMethod.POST)
	public String schoolRemoveProcess(@RequestParam(value="parent")String parent,
										 @RequestParam(value="code")String code,
										 @RequestParam(value="tab")Integer tab,
		...
		switch(tab) {
		case 1:
			nm021037Service.removeEduOffice(b_no);
			break;
		case 2:
			nm021037Service.removeEduSupport(b_no);
			break;
		}
	...
	@RequestMapping(value = "/nm021037Init.do", method = RequestMethod.GET)
	public String ajaxInit(Model model,
		...
		switch(tab) {
		case 1:
			boardList = nm021037Service.getEduOfficeSearchList(params);
			break;
		case 2:
			boardList = nm021037Service.getEduSupportSearchList(params);
			break;
		}
		model.addAttribute("boardList", boardList);
		
		return "ajax/nm021037Init";
	}
	
	@RequestMapping(value = "/nm021037Paging.do", method = RequestMethod.GET)
	public String ajaxPaging(Model model,
		...
		switch(tab) {
		case 1:
			page = nm021037Service.getEduOfficeSearchListCount(params);
			break;
		case 2:
			page = nm021037Service.getEduSupportSearchListCount(params);
			break;
		}
