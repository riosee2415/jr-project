...
@Controller
public class Ad0212Controller {

	@Resource(name = "middlewareService")
	private I_MiddlewareService middlewareService;
	
	@Resource(name = "ad0212Service")
	private I_Ad0212Service ad0212Service;
	...
	public String sendScreen(@RequestParam("mc") String mc, @RequestParam("sc") String sc, HttpSession session,
		...
		int adminRight = ad0212Service.getAdminControllRight();
	...
	@RequestMapping(value = "/ad0212Init.do", method = RequestMethod.GET)
	public String ajaxGetBoardData(Model model,
		...
		List<BoardVO> boardList = ad0212Service.getSearch(params);
	...
	@RequestMapping(value = "/ad0212Pagination.do", method = RequestMethod.GET)
	public String ajaxPagination(Model model,
		...
		int page = ad0212Service.getListCount(params);
	...
	@RequestMapping(value = "/ad0212Notice.do", method = RequestMethod.GET)
	@ResponseBody
	public int ajaxNotice(Model model,
							@RequestParam("status")int status,
							@RequestParam("no")int no) {
		
		int result = ad0212Service.chagneNoticeStatus(status, no);
		
		return result;
	}
	
	@RequestMapping(value = "/ad0212Delete.do", method = RequestMethod.GET)
	@ResponseBody
	public int ajaxDelete(Model model,
							@RequestParam("no")int no) {
		
		int result = ad0212Service.deleteOne(no);
		
		return result;
	}
	
	@RequestMapping(value = "/ad0212DeleteAll.do", method = RequestMethod.GET)
	@ResponseBody
	public int ajaxDeleteAll(Model model,
		...
		for(int i = 0; i < noArr.size(); i++) {
			result = ad0212Service.deleteOne(Integer.parseInt(noArr.get(i)));
		}
...
//	@RequestMapping(value = "/ad0212Search.do", method = RequestMethod.GET)
//	public String ajaxSearchData(Model model
//							, @RequestParam("serachVal")String serachVal
//							, @RequestParam("searchType")String searchType) {
//		
//		
//		List<BoardVO> boardList = ad0212Service.getSearch(serachVal, searchType);
//		model.addAttribute("boardList", boardList);
//		
//		return "ajax/ad0212Init";
//	}
	
	@RequestMapping(value = "/ad0212Comments.do", method = RequestMethod.GET)
	@ResponseBody
	public List<CommentsVO> getCommentById(@RequestParam("p_no")int p_no){
		
		List<CommentsVO> list = ad0212Service.getCommentsById(p_no);
		
		return list;
	}
	
	@RequestMapping(value = "/ad0212CommentDelete.do", method = RequestMethod.GET)
	@ResponseBody
	public int commentDelete(@RequestParam("co_no")int co_no){
		
		
		return ad0212Service.commentDelete(co_no);
	}
	
	
	@RequestMapping(value = "/ad0212GetRight.do", method = RequestMethod.GET)
	public String getRight(	@RequestParam("type")String type
							,Model model) {
		
		List<CommonVO> list = ad0212Service.getRight();
		model.addAttribute("RightList", list);
		
		return "ajax/adRightInit";
	}
	
	@RequestMapping(value = "/ad0212CurrentRight.do",  method = RequestMethod.GET)
	public String currentRight(Model model) {
		
		Accept_typeVO vo = ad0212Service.currentRight();
		model.addAttribute("current", vo);
		
		return "ajax/adCurrentRight";
	}
	
	@RequestMapping(value = "/ad0212UpdateRight.do",  method = RequestMethod.GET)
	public String UpdateRight(@RequestParam("type")String type,
		...
		int result = ad0212Service.UpdateRight(params);
		...
		return "redirect:ad0212GetRight.do";
	}
