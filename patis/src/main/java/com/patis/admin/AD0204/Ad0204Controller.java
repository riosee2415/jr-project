...
@Controller
public class Ad0204Controller {

	@Resource(name = "middlewareService")
	private I_MiddlewareService middlewareService;
	
	@Resource(name = "ad0204Service")
	private I_Ad0204Service ad0204Service;
	 ...
	 * @DESC : 행사알림 게시판 관리자
	 */
	@RequestMapping(value = "/admin.eventAlert.do", method = RequestMethod.GET)
	public String sendScreen(@RequestParam("mc") String mc, @RequestParam("sc") String sc, HttpSession session,
		...
		int adminRight = ad0204Service.getAdminControllRight();
	...
	@RequestMapping(value = "/ad0204Init.do", method = RequestMethod.GET)
	public String ajaxGetBoardData(Model model,
		...
		List<BoardVO> boardList = ad0204Service.getSearch(params);
	...
	@RequestMapping(value = "/ad0204Pagination.do", method = RequestMethod.GET)
	public String ajaxPagination(Model model,
		...
		int page = ad0204Service.getListCount(params);
	...
	@RequestMapping(value = "/ad0204Notice.do", method = RequestMethod.GET)
	@ResponseBody
	public int ajaxNotice(Model model,
							@RequestParam("status")int status,
							@RequestParam("no")int no) {
		
		int result = ad0204Service.chagneNoticeStatus(status, no);
		
		return result;
	}
	
	@RequestMapping(value = "/ad0204Delete.do", method = RequestMethod.GET)
	@ResponseBody
	public int ajaxDelete(Model model,
							@RequestParam("no")int no) {
		
		int result = ad0204Service.deleteOne(no);
		
		return result;
	}
	
	@RequestMapping(value = "/ad0204DeleteAll.do", method = RequestMethod.GET)
	@ResponseBody
	public int ajaxDeleteAll(Model model,
		...
		for(int i = 0; i < noArr.size(); i++) {
			result = ad0204Service.deleteOne(Integer.parseInt(noArr.get(i)));
		}
...
//	@RequestMapping(value = "/ad0204Search.do", method = RequestMethod.GET)
//	public String ajaxSearchData(Model model
//							, @RequestParam("serachVal")String serachVal
//							, @RequestParam("searchType")String searchType) {
//		
//		
//		List<BoardVO> boardList = ad0204Service.getSearch(serachVal, searchType);
//		model.addAttribute("boardList", boardList);
//		
//		return "ajax/ad0204Init";
//	}
	
	@RequestMapping(value = "/ad0204Comments.do", method = RequestMethod.GET)
	@ResponseBody
	public List<CommentsVO> getCommentById(@RequestParam("p_no")int p_no){
		
		List<CommentsVO> list = ad0204Service.getCommentsById(p_no);
		
		return list;
	}
	
	@RequestMapping(value = "/ad0204CommentDelete.do", method = RequestMethod.GET)
	@ResponseBody
	public int commentDelete(@RequestParam("co_no")int co_no){
		
		
		return ad0204Service.commentDelete(co_no);
	}
	
	
	@RequestMapping(value = "/ad0204GetRight.do", method = RequestMethod.GET)
	public String getRight(	@RequestParam("type")String type
							,Model model) {
		
		List<CommonVO> list = ad0204Service.getRight();
		model.addAttribute("RightList", list);
		
		return "ajax/adRightInit";
	}
	
	@RequestMapping(value = "/ad0204CurrentRight.do",  method = RequestMethod.GET)
	public String currentRight(Model model) {
		
		Accept_typeVO vo = ad0204Service.currentRight();
		model.addAttribute("current", vo);
		
		return "ajax/adCurrentRight";
	}
	
	@RequestMapping(value = "/ad0204UpdateRight.do",  method = RequestMethod.GET)
	public String UpdateRight(@RequestParam("type")String type,
		...
		int result = ad0204Service.UpdateRight(params);
		...
		return "redirect:ad0204GetRight.do";
	}
