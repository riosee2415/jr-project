...
public class Ad0201Controller {
	...
	@Resource(name = "ad0201Service")
	private I_Ad0201Service ad0201Service;
	 ...
	 * @DESC : 관계법령 게시판 관리자
	 */
	@RequestMapping(value = "/admin.statute.do", method = RequestMethod.GET)
	public String sendScreen(@RequestParam("mc") String mc, @RequestParam("sc") String sc, HttpSession session,
		...
		int adminRight = ad0201Service.getAdminControllRight();
	...
	@RequestMapping(value = "/ad0201Init.do", method = RequestMethod.GET)
	public String ajaxGetBoardData(Model model,
		...
		List<BoardVO> boardList = ad0201Service.getSearch(params);
	...
	@RequestMapping(value = "/ad0201Pagination.do", method = RequestMethod.GET)
	public String ajaxPagination(Model model,
		...
		int page = ad0201Service.getListCount(params);
	...
	@RequestMapping(value = "/ad0201Notice.do", method = RequestMethod.GET)
	@ResponseBody
	public int ajaxNotice(Model model,
							@RequestParam("status")int status,
							@RequestParam("no")int no) {
		
		int result = ad0201Service.chagneNoticeStatus(status, no);
		
		return result;
	}
	
	@RequestMapping(value = "/ad0201Delete.do", method = RequestMethod.GET)
	@ResponseBody
	public int ajaxDelete(Model model,
							@RequestParam("no")int no) {
		
		int result = ad0201Service.deleteOne(no);
		
		return result;
	}
	
	@RequestMapping(value = "/ad0201DeleteAll.do", method = RequestMethod.GET)
	@ResponseBody
	public int ajaxDeleteAll(Model model,
		...
		for(int i = 0; i < noArr.size(); i++) {
			result = ad0201Service.deleteOne(Integer.parseInt(noArr.get(i)));
		}
...
//	@RequestMapping(value = "/ad0201Search.do", method = RequestMethod.GET)
//	public String ajaxSearchData(Model model
//							, @RequestParam("serachVal")String serachVal
//							, @RequestParam("searchType")String searchType) {
//		
//		
//		List<BoardVO> boardList = ad0201Service.getSearch(serachVal, searchType);
//		model.addAttribute("boardList", boardList);
//		
//		return "ajax/ad0201Init";
//	}
	
	@RequestMapping(value = "/ad0201Comments.do", method = RequestMethod.GET)
	@ResponseBody
	public List<CommentsVO> getCommentById(@RequestParam("p_no")int p_no){
		
		List<CommentsVO> list = ad0201Service.getCommentsById(p_no);
		
		return list;
	}
	
	@RequestMapping(value = "/ad0201CommentDelete.do", method = RequestMethod.GET)
	@ResponseBody
	public int commentDelete(@RequestParam("co_no")int co_no){
		
		
		return ad0201Service.commentDelete(co_no);
	}
	
	
	@RequestMapping(value = "/ad0201GetRight.do", method = RequestMethod.GET)
	public String getRight(	@RequestParam("type")String type
							,Model model) {
		
		List<CommonVO> list = ad0201Service.getRight();
		model.addAttribute("RightList", list);
		
		return "ajax/adRightInit";
	}
	
	@RequestMapping(value = "/ad0201CurrentRight.do",  method = RequestMethod.GET)
	public String currentRight(Model model) {
		
		Accept_typeVO vo = ad0201Service.currentRight();
		model.addAttribute("current", vo);
		
		return "ajax/adCurrentRight";
	}
	
	@RequestMapping(value = "/ad0201UpdateRight.do",  method = RequestMethod.GET)
	public String UpdateRight(@RequestParam("type")String type,
		...
		int result = ad0201Service.UpdateRight(params);
		...
		return "redirect:ad0201GetRight.do";
	}
