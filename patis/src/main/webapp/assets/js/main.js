$(document).ready(function() {
  ...
  function slideNext() {
	  ...
	  $('#slide-btn-js .slide-button').find('.btn').removeClass('on')
	  $('#slide-btn-js .slide-button').eq(currentSlide-1).find('.btn').addClass('on')
	  
	  slideSize = $('#slide-image-js li a').css('width').replace('px', '');
