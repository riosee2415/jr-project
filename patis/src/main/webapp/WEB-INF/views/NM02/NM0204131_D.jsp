...
<div class="subpage">
  ...
  <form action="/statute.do" method="get" id="frm-${fn:toLowerCase(data.b_TYPE)}">
  ...
  <form action="/statute.detail.do" method="get" id="frm-${fn:toLowerCase(data.b_TYPE)}-detail">
  	<input type="hidden" name="parent" value="${param.parent }" />
  	<input type="hidden" name="code" value="${param.code }" />
  ...
  <form action="/statute.write.do" method="get" id="frm-${fn:toLowerCase(data.b_TYPE)}-write">
  	<input type="hidden" name="parent" value="${param.parent }" />
  	<input type="hidden" name="code" value="${param.code }" />
  	<input type="hidden" name="b_no" />
  ...
  <form action="/statute.remove.do" method="post" id="frm-${fn:toLowerCase(data.b_TYPE)}-remove">
  	<input type="hidden" name="parent" value="${param.parent }" />
  	<input type="hidden" name="code" value="${param.code }" />
  	<input type="hidden" name="b_no" />
  	<input type="hidden" name="s_type" />
