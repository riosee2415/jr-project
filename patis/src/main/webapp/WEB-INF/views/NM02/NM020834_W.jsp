    ...
    <div class="sub-content-wrap">
      ...
      >
        ...
        >
              ...
              <div class="thumbnail__box">
              		<c:if test="${mode eq 'WRITE'}">
	              		<img
			                ...
			                alt="기본 썸네일 이미지"
			                id="thumbnail-image-js" />
              		</c:if>
              		<c:if test="${mode eq 'MODIFY'}">
              			<img
			                src="${data.b_THUMB_PATH}"
			                alt="썸네일 이미지"
			                id="thumbnail-image-js" />
              		</c:if>
             			<button type="button" onclick="javascript:boardThumbnailCilckHandler()">변경하기</button>
		              <input type="file" name="thumbnail_file" id="thumbnail-file-js" class="d-none" onchange="javascript:boardThumbnailFileHandler(this)"/>
              </div>
            </div>
          </div>
     	...
     	<form action="/archive.do" method="get" id="frm-${fn:toLowerCase(b_type)}">
		    <input type="hidden" name="parent" value="${param.parent }" />
		    <input type="hidden" name="code" value="${param.code }" />
		    <input type="hidden" name="tab" value="${tab }"/>
