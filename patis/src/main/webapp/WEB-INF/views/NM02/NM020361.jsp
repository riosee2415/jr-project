      ...
      <div class="sub1-main">
        ...
        <div class="vision">
          ...
          <div class="sub-vision-content">
            ...
            <p class="sub-vision-content-desc">
              도시재생 과정에서 새로운 도시기능 도입, 지역자산 활용, 산업구조의
              변화 등을 통해 고용기반을 창출하고 소득을 증대시킨다.
            </p>
          </div>
        </div>
        <div class="vision">
        ...
        <div class="vision">
          ...
          <div class="sub-vision-content">
            주민역량 강화 및 공동체 활성화
            <p class="sub-vision-content-desc">
              살고 있는 도시의 쇠퇴 문제를 직접 고민하고 해결책을 도출하는 ‘역량
              있는 주민’을 육성하고, ‘참여하는 주민공동체’를 구현한다.
            </p>
          </div>
        </div>
        ...
        <div class="sub-main-propel">
          <div class="propel-title">
            <span class="orange">협치</span>와
            <span class="orange">상생</span>을 통한 도시재생
          </div>
          <div class="propel-content">
            <p>-도시재생사업을 통한 주거환경개선 및 삶의 질 향상</p>
            <p>-도시재생 주민역량강화 및 거버넌스 구축</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="sub-content-wrap">
      <div class="sub2-main">
        ...
        <div class="sub-history">
          ...
          <div class="sub-history__title">
            <div class="sub-history__year-green">2018</div>
            <div class="sub-history-line-green"></div>
          </div>
