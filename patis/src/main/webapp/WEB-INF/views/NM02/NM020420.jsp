    ...
    <div class="sub-content-wrap">
      ...
      <table class="nm22-tbl-style-02">
        ...
        <tbody>
          ...
          <tr>
            <td>기반시설 도입</td>
            <td>주차장, 공동이용<br />시설 등<br /> 생활편의시설</td>
      ...
      <table class="nm22-tbl-style-03">
        ...
        <tbody>
          <tr>
            <td>재생방향</td>
            <td>
              정부·민간부문과<br /> 협력적 추진일자리와<br />미래 성장동력 창출
            </td>
            <td>
              쇠퇴산&#40;상&#41;업 지역,<br />역사자원 지역을<br />지역혁신거점으로
              특화
            </td>
          ...
          <tr>
            <td>재생대상</td>
            <td>대규모(저이용) <br />가용지를 보유한 지역</td>
            <td>
              기존의 산업 또는 상업의<br />재활성화가 필요한 지역<br />지역역사·문화·자연자산의<br />활용가치가
              높은 지역
            </td>
            <td>
              노후(쇠퇴)하고<br /> 공동체 회복이 필요한<br /> 저층주거지 대상
            </td>
            <td>
