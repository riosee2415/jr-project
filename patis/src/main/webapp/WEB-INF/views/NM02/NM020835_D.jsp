...
<div class="subpage">
  ...
  <form action="/hire.do" method="get" id="frm-${fn:toLowerCase(data.b_TYPE)}">
  ...
  <form action="/hire.detail.do" method="get" id="frm-${fn:toLowerCase(data.b_TYPE)}-detail">
  	<input type="hidden" name="parent" value="${param.parent }" />
  	<input type="hidden" name="code" value="${param.code }" />
  ...
  <form action="/hire.write.do" method="get" id="frm-${fn:toLowerCase(data.b_TYPE)}-write">
  	<input type="hidden" name="parent" value="${param.parent }" />
  	<input type="hidden" name="code" value="${param.code }" />
  	<input type="hidden" name="b_no" />
  ...
  <form action="/hire.remove.do" method="post" id="frm-${fn:toLowerCase(data.b_TYPE)}-remove">
  	<input type="hidden" name="parent" value="${param.parent }" />
  	<input type="hidden" name="code" value="${param.code }" />
  	<input type="hidden" name="b_no" />
  	<input type="hidden" name="s_type" />
