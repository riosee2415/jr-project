...
<div class="subpage">
      ...
      <div class="subHead">
        <%@ include file="/WEB-INF/views/template/components/sub_title_bread.jsp" %>
			...
			<div class="board-write__box" id="board-write-js" data-btype="${b_type}" data-key="${file_key}">
				<form action="/release.write.do" method="post" id="frm-${fn:toLowerCase(b_type)}-write-process">
  ...
  <form action="/release.do" method="get" id="frm-${fn:toLowerCase(b_type)}">
  	<input type="hidden" name="parent" value="${param.parent }" />
  	<input type="hidden" name="code" value="${param.code }" />
  ...
  <form action="/release.detail.do" method="get" id="frm-${fn:toLowerCase(b_type)}-detail">
  	<input type="hidden" name="parent" value="${param.parent }" />
  	<input type="hidden" name="code" value="${param.code }" />
