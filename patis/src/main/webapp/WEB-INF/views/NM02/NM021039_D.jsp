...
<div class="subpage">
    ...
    <div class="sub-content-wrap">
      <div class="subHead">
        <%@ include file="/WEB-INF/views/template/components/sub_title_bread.jsp" %>
			...
			<div class="board-comment__area" id="board-comment-js" data-btype="${data.b_TYPE }" data-pno="${data.b_NO}">
				<%@ include file="/WEB-INF/views/template/components/board_comment.jsp" %>
			</div>
    </div>
  </div>
  
  <form action="/presentation.do" method="get" id="frm-${fn:toLowerCase(data.b_TYPE)}">
  ...
  <form action="/presentation.detail.do" method="get" id="frm-${fn:toLowerCase(data.b_TYPE)}-detail">
  	<input type="hidden" name="parent" value="${param.parent }" />
  	<input type="hidden" name="code" value="${param.code }" />
  ...
  <form action="/presentation.write.do" method="get" id="frm-${fn:toLowerCase(data.b_TYPE)}-write">
  	<input type="hidden" name="parent" value="${param.parent }" />
  	<input type="hidden" name="code" value="${param.code }" />
  	<input type="hidden" name="b_no" />
  ...
  <form action="/presentation.remove.do" method="post" id="frm-${fn:toLowerCase(data.b_TYPE)}-remove">
  	<input type="hidden" name="parent" value="${param.parent }" />
  	<input type="hidden" name="code" value="${param.code }" />
  	<input type="hidden" name="b_no" />
  	<input type="hidden" name="s_type" />
