    ...
    <div class="sub-content-wrap">
      ...
      <div class="nm0363-content">
        ...
        <div class="nm0363-tbl-style-01">
          ...
          <ul class="tbl-style-con">
            <li>
              1호선 : 신이문역(2번출구) - 1122번 버스 승차-중랑구청 앞 하차
            </li>
            <li>
              6호선 : 봉화산역(3번출구) - 241, 1122, 2012, 2115 번 버스 승차 -
              중랑구청앞 하차
            </li>
            <li>
              7호선 : 중화역(2번출구 건너편) - 273, 1122, 2115번 버스 승차 -
              중랑구청 앞 하차
            </li>
          </ul>
        </div>
        ...
        <div class="nm0363-tbl-style-01">
          ...
          <ul class="tbl-style-con">
            ...
            <li class="tbl-style-subcon">
              &lpar;7호선 먹골역 5번, 6번출구&rarr;다이소가 보이는 골목으로
              직진&rarr;신호등 맞은편&rpar;
            </li>
          </ul>
        </div>
      ...
      <div class="nm0363-content">
        ...
        <div class="nm0363-tbl-style-01">
          ...
          <ul class="tbl-style-con">
            ...
            <li class="tbl-style-subcon">
              &lpar;중화역 3번출구&rarr;오른쪽으로 직진&rarr;사거리에서 대각선
              방면&rpar;
            </li>
          </ul>
        </div>
