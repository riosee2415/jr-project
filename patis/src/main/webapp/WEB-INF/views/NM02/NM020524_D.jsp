...
<div class="subpage">
  ...
  <form action="/community.do" method="get" id="frm-${fn:toLowerCase(data.b_TYPE)}">
  ...
  <form action="/community.detail.do" method="get" id="frm-${fn:toLowerCase(data.b_TYPE)}-detail">
  	<input type="hidden" name="parent" value="${param.parent }" />
  	<input type="hidden" name="code" value="${param.code }" />
  ...
  <form action="/community.write.do" method="get" id="frm-${fn:toLowerCase(data.b_TYPE)}-write">
  	<input type="hidden" name="parent" value="${param.parent }" />
  	<input type="hidden" name="code" value="${param.code }" />
  	<input type="hidden" name="b_no" />
  ...
  <form action="/community.remove.do" method="post" id="frm-${fn:toLowerCase(data.b_TYPE)}-remove">
  	<input type="hidden" name="parent" value="${param.parent }" />
  	<input type="hidden" name="code" value="${param.code }" />
  	<input type="hidden" name="b_no" />
  	<input type="hidden" name="s_type" />
