...
<div class="subpage">
  <div class="sub-container" id="sub-container-js">
    <div class="sub-content-wrap">
      ...
      <form action="/school.detail.do" method="get" id="frm-${fn:toLowerCase(b_type_1)}-detail">
			...
			<form action="/school.write.do" method="get" id="frm-${fn:toLowerCase(b_type_1)}-write">
				<input type="hidden" name="parent" value="${param.parent }" />
				<input type="hidden" name="code" value="${param.code }" /> 
				<input type="hidden" name="tab" value="1" />
				<input type="hidden" name="s_type" /> 
    ...
    <div class="sub-content-wrap">
      ...
      <form action="/school.detail.do" method="get" id="frm-${fn:toLowerCase(b_type_2)}-detail">
		    <input type="hidden" name="parent" value="${param.parent }" />
		    <input type="hidden" name="code" value="${param.code }" />
			...
			<form action="/school.write.do" method="get" id="frm-${fn:toLowerCase(b_type_2)}-write">
				<input type="hidden" name="parent" value="${param.parent }" />
				<input type="hidden" name="code" value="${param.code }" /> 
				<input type="hidden" name="tab" value="2" />
				<input type="hidden" name="s_type" /> 
