	...
	<div class="sub-container">
			...
			<div class="nm62-content">
					...
					<ul>
						...
						<li>
							<ul class="nm62-list-style-dot">
								...
								<li>·&nbsp;2017.02.16. : 서울시 도시재생(근린재생형)활성화지역 선정</li>
								...
								<li>·&nbsp;2019.05.31. : 실현가능성 및 타당성 평가 종합평가 개최(국토부)</li>
								<li>·&nbsp;2019.07.05. : 도시재생특별위원회 심의(국무총리) - 승인</li>
								<li>·&nbsp;2019.10.25. : 도시재생위원회 심의(서울시) - 조건부가결</li>
				...
				<div class="nm62-tbl-style-01">
					...
					<ul>
						...
						<li>
							<ul class="nm62-list-style-dot">
								<li>·&nbsp;2019.08.02. : 10분 동네 생활SOC 선정 결과 알림 (시 → 구)</li>
				...
				<div class="nm62-tbl-style-01">
					...
					<ul>
						...
						<li>
							<ul class="nm62-list-style-dot">
								<li>·&nbsp;2019.10.10. : 주민공모사업 협약체결(우리구-대표 제안자)</li>
					...
					<ul>
						...
						<li>
							<ul class="nm62-list-style-dot">
								...
								<li>·&nbsp;2019.06.03. : 관리형 주고환경개선사업 대상지 결정</li>
					...
					<ul>
						...
						<li>
							<ul class="nm62-list-style-dot">
								...
								<li>·&nbsp;2019.12.16. : 선진지역 탐방(금천구 독산 1동 금하마을)</li>
		...
		<div class="nm62-page-wrap" style="display: block;">
			...
			<div class="nm62-content">
				<h3 class="nm62-title-style-01">▪종합계획도</h3>
				<div class="nm62-content-img__box">
					<img src="/assets/images/image/sub-nm62-04-01.png"
						alt="종합계획도 사진" class="nm62-content-img-04-01" />
				</div>
		...
		<div class="nm62-page-wrap" style="display: block;">
			...
			<div class="nm62-content">
				<h3 class="nm62-title-style-01">▪종합계획도</h3>
				<div class="nm62-content-img__box">
					<img src="/assets/images/image/sub-nm62-05-01.png"
						alt="종합계획도 사진" class="nm62-content-img-05-01" />
				</div>
				...
				<div class="nm62-tbl-style-01">
					...
					<ul>
						...
						<li>
							<ul class="nm62-list-style-dot">
								<li>·&nbsp;현장거점 운영, 주민모임 활성화, 도시재생 홍보 및 공감대 형성(주민)</li>
		...
		<div class="nm62-page-wrap" style="display: block;">
			...
			<div class="nm62-content">
				<h3 class="nm62-title-style-01">▪종합계획도</h3>
				<div class="nm62-content-img__box">
					<img src="/assets/images/image/sub-nm62-06-01.png"
						alt="종합계획도 사진" class="nm62-content-img-06-01" />
				</div>
		...
		<div class="nm62-page-wrap" style="display: block;">
			...
			<div class="nm62-content">
				<h3 class="nm62-title-style-01">▪종합계획도</h3>
				<div class="nm62-content-img__box">
					<img src="/assets/images/image/sub-nm62-07-01.png"
						alt="종합계획도 사진" class="nm62-content-img-07-01" />
				</div>
				...
				<div class="nm62-tbl-style-01">
					...
					<ul>
						...
						<li>
							<ul class="nm62-list-style-dot">
								<li>·&nbsp;&lt;패션봉제 클러스터&gt; 조성 &lpar;스마트앵커, 패션봉제종합정보센터,
									창업보육센터 등&rpar;</li>
								<li>·&nbsp;패션봉제&lt;비즈니스 특화가로&gt; 및 &lt;관광&sol;문화&sol;축제
									특화가로&gt;</li>
								<li>·&nbsp;&lt;플리마켓 및 공방거리&gt; 운영 &lpar;소규모 시범 재생사업&rarr;</li>
							</ul>
						</li>
					</ul>
					<ul>
						...
						<li>
							<ul class="nm62-list-style-dot">
								...
								<li>·&nbsp;2019.09.21. ~ 22. : 중량패션위크(테마 : 패션업사이클링) 개최</li>
								...
								<li>·&nbsp;2020년 : 도시재생지원센터 운영 및 주민공모사업(의견청취)진행</li>
							</ul>
						</li>
					</ul>
				</div>
