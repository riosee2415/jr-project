...
<nav class="left-menu">
	...
	<div class="left-menu-list__box" id="left-menu-list-js">
		...
		<div class="lefe-menu-list__area <c:if test="${param.mc eq 2}">active</c:if>">
			...
			<ul class="left-menu-sub">
        <li onclick="javascript:subMenuHandler('/admin.statute.do', 2, 1)">도시재생 관계법령</li>
        <li onclick="javascript:subMenuHandler('/admin.community.do', 2, 2)">마을커뮤니티</li>
        <li onclick="javascript:subMenuHandler('/admin.notice.do', 2, 3)">공지사항</li>
        <li onclick="javascript:subMenuHandler('/admin.eventAlert.do', 2, 4)">행사알림</li>
        <li onclick="javascript:subMenuHandler('/admin.eventArchive.do', 2, 5)">행사자료</li>
        <li onclick="javascript:subMenuHandler('/admin.release.do', 2, 6)">보도자료</li>
        <li onclick="javascript:subMenuHandler('/admin.yardOffice.do', 2, 7)">구청[사진 및 영상자료]</li>
