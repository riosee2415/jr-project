		...
		<div class="stis_one__desc">
			...
			<div class="stis_one__desc__right">
				...
				<div class="stis_one__desc__right__detail">
					<input type="submit" class="btn btn-sm btn-gray" value="자세히보기"
	...
	<div class="stis_one">
		...
		<div class="stis_one__desc">
			...
			<div class="stis_one__desc__right">
				...
				<div class="desc__right__dateArea">
					<input type="submit" class="btn btn-sm btn-gray" value="조회하기"
		...
		<div class="stis_one__desc">
			...
			<div class="stis_one__desc__right">
				<div class="stis_one__desc__right__data" id="sits-search-data-js">0</div>
				<div class="stis_one__desc__right__detail">
					<input type="submit" class="btn btn-sm btn-gray" value="자세히보기"
